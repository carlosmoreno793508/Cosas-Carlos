...
│   └── roku/            # Fase 3 — Canal Roku (BrightScript / SceneGraph)
└── docs/
...
- ✅ **Fase 3 — Roku** (`apps/roku`): scaffold en BrightScript/SceneGraph con
  cliente Xtream, parser M3U, rejilla de canales y reproductor HLS. Ver
  `apps/roku/README.md`.
